...
def load_csv_data():
    ...
    # Use the more robust 'python' engine and explicitly name the columns
    # This will correctly parse the messy CSV file and prevent data loss.
    df = pd.read_csv(
        '4d_results_history.csv',
        engine='python',
        header=0, # The first row is the header
        names=['date', 'provider', 'draw_info', '1st', '2nd', '3rd', 'special', 'consolation'],
        on_bad_lines='warn' # Use 'warn' to see issues instead of silently skipping
    )
