...
def quick_pick():
    try:
        ...
        return render_template('quick_pick_simple.html',
                             numbers=numbers,
...
def decision_helper():
    return "<h1>Decision Helper Working!</h1><p>Hot Numbers: 1234, 5678, 9012</p><p>AI Recommends: 3456</p><a href='/dashboard'>Back</a>"
