// THEME SWITCHER with Spider-Man
const themes = ['dark', 'light', 'neon', 'ocean', 'sunset', 'forest', 'spiderman'];
...
function initTheme() {
  ...
  toggle.innerHTML = `
    ...
    <button class="theme-btn" data-theme="spiderman" title="Spider-Man">🕷️</button>
  `;
